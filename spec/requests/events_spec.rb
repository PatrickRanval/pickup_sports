...
RSpec.describe "Events", type: :request do
  ...
  describe "POST /events" do
    ...
    it "returns a successful responst" do
  ...
  describe "DELETE /events/:id" do
    ...
    # Test redundant with model test that German leaves in code by accident?
    # Patrick leaves in code for consistency of number of tests
